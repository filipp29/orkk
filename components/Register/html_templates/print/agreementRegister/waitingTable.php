...
//        "amount" => ($info["fullAmount"]). " тг",
//        "speed" => ($info["fullSpeed"]). " мбит/с",
//        "comment" => $view->show("inc.div",[
//            "type" => "column",
//            "content" => $commentButtonBlock.$view->show("inc.text",[
//                "text" => nl2br($posList[0]["comment"]),
//                "attribute" => [
//                    "id" => "hiddenText"
//                ],
//                "style" => [
...
//    ];
    ...
    $tr = [
        ...
        "comment" => $view->show("inc.div",[
            "type" => "column",
            "content" => $getCommentButtonBlock(). $view->show("inc.var",[
                "key" => "tr_clientId",
                "value" => $clientId
            ],true),
            "class" => "hiddenTextContainer"
